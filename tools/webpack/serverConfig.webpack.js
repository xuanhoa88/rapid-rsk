...
import baseConfig, { isDebug, verboseConfig } from './baseConfig.webpack';
...
export default merge(baseConfig, {
  ...
  externals: [
    './chunk-manifest.json', // Generated by client build
    nodeExternals({
      allowlist: [
        /\.css$/, // CSS files must be bundled (need css-loader + isomorphic-style-loader)
      ],
    }),
  ],
